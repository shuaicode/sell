package com.shuai.ordering.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.shuai.ordering.controller.Seller*.*(..))" +
            "&& !execution(public * com.shuai.ordering.controller.SellerUserController.*(..))")
    public void verify() {
